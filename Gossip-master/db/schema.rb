...
ActiveRecord::Schema.define(version: 2019_08_01_183931) do
  ...
  create_table "join_table_potins", force: :cascade do |t|
    t.integer "tag_id"
    t.integer "potin_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["potin_id"], name: "index_join_table_potins_on_potin_id"
    t.index ["tag_id"], name: "index_join_table_potins_on_tag_id"
  end
